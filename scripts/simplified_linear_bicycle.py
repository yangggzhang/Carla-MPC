...
C_temp = np.array([[ yaw*v*sin(angel) + (delta*lr*v*sin(angel)*deno1)/(L*(deno2)],
                   [ -yaw*v*cos(angel) - (delta*lr*v*cos(angel)*deno1)/(L*(deno2)],
                   [ 0],
                   [ -delta*((v*deno1)/(deno3) - (lr**2*v*tandelta**2*deno1)/(deno3**3)]])
